...
\figref{fig:sciopsorg} gives a view of the Data Production teams which combine some of the old science operations  and \gls{LDF} departments. This is far more analogous to \gls{Data Management} moving into operations than in the current proposal and would make for a smoother transition.
...
The \gls{FTE} counts are estimated in \tabref{tab:FTE}, which also gives the team sizes from the operations proposal for comparison.
