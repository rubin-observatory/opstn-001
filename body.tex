...
An initial approach to a \gls{cloud} costing was outlined in \citeds{DMTN-072}, this approach was to try to cost the hardware and compare to \gls{cloud} pricing.
