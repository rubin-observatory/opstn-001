...
All data facility work, be it with a partner or in commercial \gls{cloud} should be firmly under science operations - hence there is no \gls{LDF} department and no associate director for \gls{LDF} as depicted in \figref{fig:opsorg}.\footnote{This is  in line with AMCL recommendations}
